...
INSERT INTO CluSys.Athlete VALUES
  ...
  ('1232', 'André', 'Gomes', 'Gomes', '19960402', '/assets/img/3.jpg', '931111112', 'andre@ua.pt', HASHBYTES('SHA2_512', 'andre'), 'estudante', 'destro', 'Futebol'),
  ('1233', 'João', 'Tiago', 'Branquinho', '19930402', '/assets/img/14.jpg', '931111113', 'joao@ua.pt', HASHBYTES('SHA2_512', 'joao'), 'professor', 'esquerdino', 'Futebol'),
  ...
  ('1235', 'Gabriel', 'Soares', 'Patrício', '19960402', '/assets/img/25.jpg', '931111115', 'gabriel@ua.pt', HASHBYTES('SHA2_512', 'gabriel'), 'engenheiro agronomo', 'destro', 'Futebol'),
  ...
  ('1241', 'Cílio', NULL, 'Sousa', '19960622', '/assets/img/68.jpg', '931111121', 'cilio@ua.pt', HASHBYTES('SHA2_512', 'cilio'), 'estudante', 'destro', 'Futebol'),
  ...
  ('1243', 'Fábio', 'Miguel', 'Maio', '19930402', '/assets/img/77.jpg', '931111123', 'fabio@ua.pt', HASHBYTES('SHA2_512', 'fabio'), 'vendedor', 'esquerdino', 'Basquetebol'),
...
INSERT INTO CluSys.Physiotherapist VALUES
  ('12123', 'João', 'Martins', 'Cabrita', '19940321', NULL, '911343454', 'cabrita@ua.pt', HASHBYTES('SHA2_512', 'cabrita')),
  ('121231', 'Rui', 'Filipe', 'Martins', '19940311', NULL, '911343455', 'rui@ua.pt', HASHBYTES('SHA2_512', 'rui'));

INSERT INTO CluSys.Coach VALUES
  ('123123', 'António', 'Cruz', 'Ferreira', '20121212', NULL, '938445155', 'antonio@gmail.com', HASHBYTES('SHA2_512', 'antonio'), 'Professor');

INSERT INTO CluSys.Trains VALUES
  ('Futebol', 'Séniores', '123123', 2017);
